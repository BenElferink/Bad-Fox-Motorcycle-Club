...
//       setNumberOfChoices(populatedWallet.assets[BAD_KEY_POLICY_ID].length)
//       setAvailableChoices(payload.sort((a, b) => a.num - b.num))
//       syncWalletReservations(populatedWallet.stakeKey, payload)
//     }
//   }, [populatedWallet])
...
//               onClick={() =>
//                 handleClickAsset(
//                   populatedWallet?.stakeKey as string,
//                   item.num,
//                   reserved.findIndex((num) => num === item.num) !== -1
//                 )
//               }
//               disabled={loading}
